...
export default function ShabbatTimes() {
  ...
  return (
    <div className="hidden lg:flex relative items-center gap-4 bg-white/95 backdrop-blur-sm shadow-soft border border-ink-100 rounded-full px-5 py-2.5 animate-fade-up" ref={dropdownRef}>
