      ...
      <nav id="navbar" className={`fixed w-full z-50 transition-all duration-500 border-b ${isNavGlass ? "glass shadow-soft border-ink-100" : "bg-transparent border-ink-100/0"}`}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="flex justify-between items-center h-20 md:h-24">
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <Link href="/relationships-guide" className={`px-4 py-2.5 font-semibold text-[15px] rounded-xl transition-all ${pathname === '/relationships-guide' ? 'text-primary-600 bg-primary-50' : 'text-ink-600 hover:text-primary-600 hover:bg-primary-50'}`}>������ ������</Link>
        ...
        <div id="mobile-menu" className={`lg:hidden bg-white/98 backdrop-blur-2xl border-t border-ink-100 ${isMenuOpen ? "open" : ""}`}>
          <div className="px-5 py-6 space-y-1">
            ...
            <Link href="/relationships-guide" onClick={() => setIsMenuOpen(false)} className={`block px-5 py-4 text-base font-semibold rounded-2xl transition-all ${pathname === '/relationships-guide' ? 'text-primary-600 bg-primary-50' : 'text-ink-700 hover:text-primary-600 hover:bg-primary-50'}`}>������ ������</Link>
