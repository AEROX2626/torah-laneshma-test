      ...
      <nav id="navbar" className={`fixed w-full z-50 transition-all duration-500 border-b ${isNavGlass ? "glass shadow-soft border-ink-100" : "bg-transparent border-ink-100/0"}`}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="flex justify-between items-center h-20 md:h-24">
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <Link href="/ask" className={`px-4 py-2.5 font-bold text-[15px] rounded-xl transition-all flex items-center gap-2 ${pathname === '/ask' ? 'text-primary-700 bg-primary-100/80' : 'text-primary-600 bg-primary-50 hover:bg-primary-100/80'}`}><i className="fas fa-robot text-primary-500"></i>��� �� ���</Link>
        ...
        <div id="mobile-menu" className={`lg:hidden bg-white/98 backdrop-blur-2xl border-t border-ink-100 ${isMenuOpen ? "open" : ""}`}>
          <div className="px-5 py-6 space-y-1">
            ...
            <Link href="/ask" onClick={() => setIsMenuOpen(false)} className={`block px-5 py-4 text-base font-bold rounded-2xl transition-all flex items-center gap-3 ${pathname === '/ask' ? 'text-primary-700 bg-primary-100/80' : 'text-primary-600 bg-primary-50 hover:bg-primary-100/80'}`}><i className="fas fa-robot text-primary-500"></i>��� �� ���</Link>
