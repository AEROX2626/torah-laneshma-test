      ...
      <nav id="navbar" className={`fixed w-full z-50 transition-all duration-500 ${isNavGlass ? "glass shadow-soft" : ""}`}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="flex justify-between items-center h-20 md:h-24">
            ...
            <div className="hidden lg:flex items-center gap-1">
              <a href="#about" onClick={(e) => scrollToSection(e, "#about")} className="px-4 py-2.5 text-ink-600 hover:text-primary-600 font-semibold text-[15px] rounded-xl hover:bg-primary-50 transition-all">מהי חברותא?</a>
              ...
              <a href="#content" onClick={(e) => scrollToSection(e, "#content")} className="px-4 py-2.5 text-ink-600 hover:text-primary-600 font-semibold text-[15px] rounded-xl hover:bg-primary-50 transition-all">תוכן והשראה</a>
              <a href="#faq" onClick={(e) => scrollToSection(e, "#faq")} className="px-4 py-2.5 text-ink-600 hover:text-primary-600 font-semibold text-[15px] rounded-xl hover:bg-primary-50 transition-all">שאלות נפוצות</a>
        ...
        <div id="mobile-menu" className={`lg:hidden bg-white/98 backdrop-blur-2xl border-t border-ink-100 ${isMenuOpen ? "open" : ""}`}>
          <div className="px-5 py-6 space-y-1">
            <a href="#about" onClick={(e) => scrollToSection(e, "#about")} className="block px-5 py-4 text-base font-semibold text-ink-700 hover:text-primary-600 hover:bg-primary-50 rounded-2xl transition-all">מהי חברותא?</a>
            ...
            <a href="#content" onClick={(e) => scrollToSection(e, "#content")} className="block px-5 py-4 text-base font-semibold text-ink-700 hover:text-primary-600 hover:bg-primary-50 rounded-2xl transition-all">תוכן והשראה</a>
            ...
            <div className="lg:w-7/12 p-8 md:p-14 bg-white">
              <form id="signup-form" className="space-y-6" onSubmit={handleFormSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select id="topic" className="w-full input-modern p-4 rounded-2xl text-ink-900 appearance-none pl-12 font-medium text-base cursor-pointer" defaultValue="">
                      ...
                      <option value="talmud">תלמוד או גמרא לעומק</option>
                      <option value="halacha">הלכה ומושגי יסוד</option>
                      <option value="open">תפתיעו אותי – אשמח להמלצה</option>
                    </select>
                ...
                <div className="space-y-2">
                  ...
                  <textarea id="notes" rows={3} className="w-full input-modern p-4 rounded-2xl text-ink-900 font-medium text-base resize-none" placeholder="זה הזמן לספר על עצמך, על שעות שנוחות לך, או כל בקשה מיוחדת שתעזור לנו לדייק..."></textarea>
                </div>
          ...
          <div className="grid md:grid-cols-12 gap-10 md:gap-8 mb-14">
            ...
            <div className="md:col-span-3">
              ...
              <ul className="space-y-3">
                <li><a href="#about" onClick={(e) => scrollToSection(e, "#about")} className="text-ink-600 hover:text-primary-600 font-semibold transition-colors">מהות החברותא</a></li>
                <li><a href="#how" onClick={(e) => scrollToSection(e, "#how")} className="text-ink-600 hover:text-primary-600 font-semibold transition-colors">תכלס, איך מתחילים?</a></li>
                <li><a href="#content" onClick={(e) => scrollToSection(e, "#content")} className="text-ink-600 hover:text-primary-600 font-semibold transition-colors">מאמרים והשראה</a></li>
                <li><a href="#faq" onClick={(e) => scrollToSection(e, "#faq")} className="text-ink-600 hover:text-primary-600 font-semibold transition-colors">כל מה שרציתם לשאול</a></li>
                <li><a href="#join" onClick={(e) => scrollToSection(e, "#join")} className="text-ink-600 hover:text-primary-600 font-semibold transition-colors">השארת פרטים</a></li>
              </ul>
            </div>
