              ...
              <form id="signup-form" className="space-y-6" onSubmit={handleFormSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="tel" id="phone" name="מספר_טלפון" required pattern="[0-9]{9,10}" className="w-full input-modern p-4 rounded-2xl text-ink-900 text-left font-medium text-base" dir="ltr" placeholder="050-0000000" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea id="notes" name="הערות_נוספות" rows={3} className="w-full input-modern p-4 rounded-2xl text-ink-900 font-medium text-base resize-none" placeholder="זה הזמן לספר על עצמך, על שעות שנוחות לך, או כל בקשה מיוחדת שתעזור לנו לדייק..."></textarea>
                </div>
